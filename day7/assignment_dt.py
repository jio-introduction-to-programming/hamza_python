...
def datetime_to_str_8(dt):
    return dt.strftime("%Y-%m-%d %H:%M:%S")  # Convert to format "2023-07-19 10:30:45"

def datetime_to_str_9(dt):
    return dt.strftime("%H:%M:%S")  # Convert to format "10:30:45"
...
def str_to_datetime_8(s):
    return datetime.strptime(s, "%Y-%m-%d %H:%M:%S")  # Convert from format "2023-07-19 10:30:45"

def str_to_datetime_9(s):
    return datetime.strptime(s, "%H:%M:%S")  # Convert from format "10:30:45"
